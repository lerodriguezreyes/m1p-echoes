...
window.addEventListener("load", () => {
  ...
  let mobImagesArray = [
    "https://github.com/lerodriguezreyes/m1p-echoes/blob/main/Images/eyes.png?raw=true","https://github.com/lerodriguezreyes/m1p-echoes/blob/main/Images/mob1.png?raw=true","https://github.com/lerodriguezreyes/m1p-echoes/blob/main/Images/mob2.png?raw=true"
  ]
  ...
  let gameRoom = document.getElementById('roomGameplay')
  
  let image = document.getElementById('container-image')

  let startBurtton = document.getElementById('start-game')

  startBurtton.addEventListener('click', () => {
    landingScreen.style.display = 'none'
    landingScreen.style.height = '0p'
    gameRoom.style.display = 'inherit'
    console.log("clicking")
    image.src = roomImagesArray[position]
    position++
  })
...
const roomDescription = {
    ...
    victory: `After defeating the unknown horror, the vault door opens. Instead of returning to the SCP Foundation's workspace, you find yourself greeted by Bob in front of yet another vault door. He said, "Took you long enough!" You think to yourself, there really is no rest for the wicked."`
}
...
currentPlayer = []
  ...
  const plaqueNote = 'Fellow Iron-hunters, I understand this situation may be unsettling. However, it is vital that you heed my instructions to the best of your abilities. Regrettably, I cannot provide further details, it could endanger us all. Rest assured; we are embarking on a hunt for the most dangerous quarry our organization has ever faced. More information awaits within the containment chamber. Upon ingress, the doors will seal behind you. You will be contained inside until the sequence automatically initiates 24 hours later. It is imperative not to overlook this timeframe. Refrain from bringing more rations than necessary for the allotted hours. Lastly, under no circumstances should you take anything out of the containment vault. Wishing you all the best of luck. Your mentor, Bob.'

  const hallnote = `Hi me. Yeah, this is weird. I’m taking to myself via letters here. It’s a shitty situation. If it’s any consolation this is not the first time you’ve been here! As best as we gather, this has happened before. Hell, I’d bet it’s been going on ever since ol’ Bob disappeared. This place contains a ancient secret we are fighting. The warning's real; we’re picking up Bob's slack after he went on break and never came back. So yeah, we’re stuck here trying to bootstrap a solution from remains and stuff we’ve cobbled up together. We're so close to figuring this out. The next page contains the details of the threat but DON’T READ IT YET. Explore first. With love, from me to me ${currentPlayer}.`
